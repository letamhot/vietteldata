...
<main>
    ...
    <section class="about-low-area section-padding2" style="padding: 0;">
        <div class="container">
            @foreach ($products->groupBy('tag.chiTietLoaiGoiCuoc') as $chiTietLoaiGoiCuoc => $productGroup)
            <div class="container section-title-container">
                <h1 class="section-title section-title-normal">
                    <b></b><span class="section-title-main">{{ $chiTietLoaiGoiCuoc }}</span><b></b>
                    <a href="{{ route('products.byTag', ['tag' => $chiTietLoaiGoiCuoc]) }}" target="">
