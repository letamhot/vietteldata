...
<section class="about-low-area section-padding2" style="padding: 0;">
    <div class="container">
        ...
        <ol class="breadcrumb" style="    background-color: #fff;">
            ...
            <li class="breadcrumb-item active" aria-current="page" style="    color: #fa0202;font-weight: 800;">{{ $category->tenLoaiGoiCuoc }}</li>
        </ol>
    </nav>
        ...
        <div class="container section-title-container">
            <h1 class="section-title section-title-normal">
                <b></b><span class="section-title-main">{{ $tag->chiTietLoaiGoiCuoc }}</span><b></b>
            </h1>
        </div>
